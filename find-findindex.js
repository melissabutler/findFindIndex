...
which accepts an array of objects, each with a key of username, and a string.
...
function removeUser(usersArray, username) {
 let cutIndex = usersArray.findIndex(function(value){
    return value.username === username;
  })
  if(cutIndex === -1) return;
  return usersArray.splice(cutIndex, 1)[0];
}